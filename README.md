...
Create `.github/workflows/github-actions-version-audit.yml`:
  ...
  audit:
    ...
    steps:
      ...
      - name: Audit outdated GitHub Actions
        uses: varunchandak/gh-actions-version-audit@3030900d76569f5aac4c9b43f48706c4a2453c92 # v1.1.8
        with:
          slack_webhook_url: ${{ secrets.SLACK_WEBHOOK_URL }}
```

The GitHub Marketplace **Use latest version** button shows only the action step because that popover is generated by GitHub. Use the workflow above for a complete copy-paste setup.
